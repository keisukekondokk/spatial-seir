...
#Save
ggsave(file = "output/fig/paper/fig_map_ratio_population_time20.eps", plot = g2)
ggsave(file = "output/fig/paper/fig_map_ratio_population_time20.svg", plot = g2)
ggsave(file = "output/fig/paper/fig_map_ratio_population_weekday_time20.eps", plot = p4)
ggsave(file = "output/fig/paper/fig_map_ratio_population_weekday_time20.svg", plot = p4)
ggsave(file = "output/fig/paper/fig_map_ratio_population_weekend_time20.eps", plot = p5)
ggsave(file = "output/fig/paper/fig_map_ratio_population_weekend_time20.svg", plot = p5)
