...
sfFlow <- sf::read_sf("data/shp/SHP_lines_od_flows_by_pref_time20.shp")
sfFlow <- sfFlow %>%
...
for(i in 1:2){
  ...
  #Save Each Plot
  filename <- paste0("output/fig/paper/fig_tile_national_", i, "_mobility_time20.eps")
...
#Save
saveFilenameEps <- paste0("output/fig/paper/fig_tile_national_mobility_time20.eps")
saveFileNameSvg <- paste0("output/fig/paper/fig_tile_national_mobility_time20.svg")
...
for(i in 1:2){
  ...
  #Save Each Plot
  filenameEps <- paste0("output/fig/paper/fig_tile_national_", i, "_mobility_time20_drop_diagonal.eps")
...
#Save
saveFilenameEps <- paste0("output/fig/paper/fig_tile_national_mobility_time20_drop_diagonal.eps")
saveFileNameSvg <- paste0("output/fig/paper/fig_tile_national_mobility_time20_drop_diagonal.svg")
...
for(i in 1:2){
  ...
  #Save Each Plot
  filenameEps <- paste0("output/fig/paper/fig_tile_tokyo_", i, "_mobility_time20.eps")
...
#Save
saveFilenameEps <- paste0("output/fig/paper/fig_tile_tokyo_mobility_time20.eps")
saveFileNameSvg <- paste0("output/fig/paper/fig_tile_tokyo_mobility_time20.svg")
...
for(i in 1:2){
  ...
  #Save Each Plot
  filenameEps <- paste0("output/fig/paper/fig_tile_nagoya_", i, "_mobility_time20.eps")
...
#Save
saveFilenameEps <- paste0("output/fig/paper/fig_tile_nagoya_mobility_time20.eps")
saveFileNameSvg <- paste0("output/fig/paper/fig_tile_nagoya_mobility_time20.svg")
...
for(i in 1:2){
  ...
  #Save Each Plot
  saveFilenameEps <- paste0("output/fig/paper/fig_tile_osaka_", i, "_mobility_time20.eps")
...
#Save
saveFilenameEps <- paste0("output/fig/paper/fig_tile_osaka_mobility_time20.eps")
saveFileNameSvg <- paste0("output/fig/paper/fig_tile_osaka_mobility_time20.svg")
