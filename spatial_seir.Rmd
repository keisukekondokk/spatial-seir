...
```{r make_figure_data_for_paper}
#Make figures used in the paper
source("r/spatial_seir_make_figure_odmatrix.R", echo = TRUE, prompt.echo = "", spaced = FALSE)
source("r/spatial_seir_make_figure_map.R", echo = TRUE, prompt.echo = "", spaced = FALSE)
```
