...
source("r/spatial_seir_make_figure_ratio.R", echo = TRUE, prompt.echo = "", spaced = FALSE)
...
source("r/spatial_seir_make_figure_ratio_paper.R", echo = TRUE, prompt.echo = "", spaced = FALSE)
```
